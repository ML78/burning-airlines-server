...
f2 = Flight.create(:flight_number => '3400', :flight_from => 'Melbourne', :flight_to => 'Brisbane', :flight_date => '2018-05-25 9:00:00')
f3 = Flight.create(:flight_number => '2400', :flight_from => 'Brisbane', :flight_to => 'Adelaide', :flight_date => '2018-04-30 14:30:00')
